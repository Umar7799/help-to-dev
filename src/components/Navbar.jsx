    ...
    return (
            <div ref={navbarRef} className='w-full fixed z-10 h-[48px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 shadow-sm'>
                <div className='flex'>
                    ...
                    <div className={!leftBarMenu ? 'hidden' : 'md:hidden text-sm bg-[#F7F7F7] rounded border border-gray-300 shadow-md absolute left-0 top-[48px] text-black w-[250px] h-[350px]'}>
